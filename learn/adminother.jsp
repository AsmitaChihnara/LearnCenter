...
<html lang="en">
<head>
<title>Learn Center | admins</title>
<meta charset="utf-8">
...
try{ 
rs=st.executeQuery("select * from employee where desig='admin' and eid<>'"+(String)session.getAttribute("uid")+"'");
 while(rs.next()){
%>
 <div>
