...
<html lang="en">
<head>
<title>Learn Center | Author Regn.</title>
<meta charset="utf-8">
...
function verify(){
 if(document.f1.aname.value==""){
    alert("Enter Author's name.");
	//document.f2.t5.focus();
	return false;
 }else if(document.f1.qual.value==""){
     alert("Enter Qualification.");
	return false;
 }else if(document.f1.job.value==""){
     alert("Enter Job.");
	return false;
 }else if(document.f1.desig.value==""){
     alert("Enter Designation.");
	return false;
 }else if(document.f1.award.value==""){
     alert("Enter award.");
	return false;
 }else if(document.f1.recog.value==""){
     alert("Enter recognition.");
	return false;
 }else if(document.f1.fname.value==""){
     alert("Enter father's name.");
	return false;
 }else if(document.f1.ph.value==""){
...
<div class="body2">
      ...
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              <h2>Admin page<br></h2>
			  <h4>Registering New Author: </h4>
                <div>
				<br>
			<form action="newauth1.jsp" method="post" name="f1">
 ...
 <tr>
   <td>Author Name:</td>
    <td><input type="text" name="aname" style="border-color:#000099; border-style:groove"></td></tr>
 <tr>
   <td>Qualification:</td>
    <td><input type="text" name="qual" style="border-color:#000099; border-style:groove"></td></tr>
 <tr>
   <td>Job:</td>
    <td><input type="text" name="job" style="border-color:#000099; border-style:groove"></td></tr>
<tr>
   <td>Designation:</td>
    <td><input type="text" name="desig" style="border-color:#000099; border-style:groove"></td></tr>
<tr>
   <td>Award:</td>
    <td><input type="text" name="award" style="border-color:#000099; border-style:groove"></td></tr>
<tr>
   <td>Recognition:</td>
    <td><input type="text" name="recog" style="border-color:#000099; border-style:groove"></td></tr>
<tr>
   <td>Father's Name:</td>
    <td><input type="text" name="fname" style="border-color:#000099; border-style:groove"></td></tr>
<tr>
   <td>Contact no.:</td>
    <td><input type="text" name="ph" style="border-color:#000099; border-style:groove"></td></tr>
<tr>
   <td>Email ID:</td>
    <td><input type="mail" name="mail" style="border-color:#000099; border-style:groove"></td></tr>
<tr>
   <td>DOB:</td>
    <td><input type="date" name="dob" style="border-color:#000099; border-style:groove"></td></tr>	
<tr>
   <td>Gender:</td>
    <td><input type="radio" name="gen" value="male" >Male</td>&nbsp; <td><input type="radio" name="gen" value="female" >Female</td></tr>		
<tr>
