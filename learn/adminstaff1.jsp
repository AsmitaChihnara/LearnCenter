...
<html lang="en">
<head>
<title>Learn Center | Staffs</title>
<meta charset="utf-8">
...
<strong>
<table>
<tr><td>Staff ID:</td><td><%=rs.getString(1)%></td></tr>
...
<a href="adminedit.jsp?eid=<%=rs.getString(1)%>" class="button"><span><span>Edit Profile</span></span></a><a href="delete.jsp?eid=<%=rs.getString(1)%>" class="button"><span><span>Delete Profile</span></span></a>
<br><br>
<% }
            ...
            <div class="wrapper">
              <article class="col_1">
                ...
                <p>USA<br>
                  San Diego<br>
                  Beach st. 54<br>
                  <a target="blank" href="http://lcenter@mail.com">lcenter@mail.com</a> </p>
              </article>
