...
<html lang="en">
<head>
<title>Learn Center | Faculty Home</title>
<meta charset="utf-8">
        ...
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              <h2>Faculty page</h2>
                <div>
			 <form action="faccat.jsp" method="post" name="f2">
			<h4><br>
			<h2 class="font2">Choose the category of books you want to know the details </h2>
			...
			<a href="facaddcat.jsp" class="button"><span><span>Add new category</span></span></a>
			<% try{
...
%>
          ...
          <article class="col2 pad_left2">
            <div class="pad_left1">
              ...
              <p><h3><%=(String)session.getAttribute("name")%><br>
              Faculty
              </h3>
              <br>
