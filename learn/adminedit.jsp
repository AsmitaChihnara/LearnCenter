...
%>
			...
			try{ 
rs=st.executeQuery("select * from employee where eid='"+editid+"'");
 if(rs.next()){
			%>
			<form action="edit.jsp" method="post">
			<table><h3>
<tr><td>Staff ID:</td><td><input type="hidden" name="eid" value="<%=rs.getString(1)%>"><%=rs.getString(1)%></td></tr>
<tr><td>Name:</td><td><input type="hidden" name="ename" value="<%=rs.getString(2)%>"><%=rs.getString(2)%></td></tr>
<tr><td>Designation:</td><td><input type="text" name="desig" value="<%=rs.getString(9)%>" style="border-color:#000099; border-style:groove"></td></tr>
