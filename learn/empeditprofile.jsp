...
function verify(){
 if(document.f1.fname.value==""||document.f1.dob.value==""||document.f1.ph.value==""||document.f1.mail.value==""||document.f1.qual.value==""||document.f1.cadd.value==""||document.f1.padd.value==""){
...
rs=st.executeQuery("select * from employee where name='"+name+"'");
 if(rs.next()){
			%>
			<form action="empeditprofile1.jsp" method="post" name="f1">
			<table><h3>
<tr>
  <td> ID:</td>
  <td><input type="hidden" name="id" value="<%=rs.getString(1)%>"><%=rs.getString(1)%></td></tr>
...
<tr><td>Qualification:</td><td><input type="text" name="qual" value="<%=rs.getString(8)%>" style="border-color:#000099; border-style:groove"></td></tr>
<tr><td>Current Address:</td><td><input type="text" name="cadd" value="<%=rs.getString(10)%>" style="border-color:#000099; border-style:groove"></td></tr>
<tr><td>Permanent Address:</td><td><input type="text" name="padd" value="<%=rs.getString(11)%>" style="border-color:#000099; border-style:groove"></td></tr>
...
<% }
 con.close();}catch(Exception e){out.print(e); }%>
	 ...
	 <a href="empchangepwd.jsp" class="button"><span><span>Change Password</span></span></a>			
                  </div>
