        ...
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              ...
              <h2 class="pad_bot1">faculty page
            </div>
			...
			<a enctype="multipart/form-data" href="readbook.jsp" class="button"><span><span>Read book</span></span></a><a href="fachome.jsp" class="button"><span><span>Go Back</span></span></a>
