...
<html lang="en">
<head>
<title>Learn Center | Book edit</title>
<meta charset="utf-8">
...
function verify1(){
 if(document.f2.bname.value==""){
    alert("Enter book name.");
	//document.f2.t4.focus();
	return false;
 }else if(document.f2.cd.value==""){
    alert("Enter cd.");
	//document.f2.t4.focus();
	return false;
 }else if(document.f2.dpr.value==""){
    alert("Enter dpr.");
	//document.f2.t4.focus();
	return false;
 } if(document.f2.rate.value==""){
    alert("Enter ratings.");
	//document.f2.t4.focus();
	return false;
 }else 
...
rs=st.executeQuery("select * from book where bid='"+bid+"'");
 if(rs.next()){
			%>
			<form action="adminbookedit1.jsp" method="post" name="f2">
			<table><h3>
<tr><td>Book ID:</td><td><%=rs.getString(1)%></td></tr>
<tr><td>Name:</td><td><input type="text" name="bname" value="<%=rs.getString(2)%>" style="border-color:#000099; border-style:groove"></td></tr>
<tr><td>Ratings:</td><td><input type="text" name="rate" value="<%=rs.getString(8)%>" style="border-color:#000099; border-style:groove"></td></tr>
<tr><td>CD:</td><td><input type="text" name="cd" value="<%=rs.getString(9)%>" style="border-color:#000099; border-style:groove"></td></tr>
<tr><td>DPR:</td><td><input type="date" name="dpr" value="<%=rs.getString(12)%>" style="border-color:#000099; border-style:groove"></td></tr>
<tr><td><input type="submit" value="Go" onClick="return verify1()"></td></tr>
</h3></table><br></form>
<br><br>
<% }
