      ...
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            ...
            <form action="bookedit.jsp" method="get" name="f2">
			<h2 class="font2">Choose book you want to know the details</h2>
			...
			cnt++;
			%>
						 <br><input type="radio" name="t6" id="t6" value="<%=rs.getString(1)%>" selected /><%=rs.getString(2)%>
						 
			<%}if(cnt!=0){%>
			
			 <br><input name="submit" type="submit" value="Go" onClick="return verify1()"></h3>
			 <%}
			else{%><h4>No book available.</h4><%}%>
			</form>
			<br><a href="addbook.jsp?scatid=<%=scat%>" class="button"><span><span>Add new book</span></span></a><br>
			<%
			 try{
