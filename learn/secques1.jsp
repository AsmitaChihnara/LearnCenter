...
%>
     ...
     String ans=request.getParameter("ans");
	    String fna=(String)session.getAttribute("fna");
	 
	 rs=st.executeQuery("select * from login where  secans='"+ans+"'");
	 if(rs.next()){
	 %><form action="secans.jsp" method="post" name="f1">
		<table><h3>
			<tr>
  <td width="212">Change Your Password:</td>
  <tr><td> <input type="hidden" name="na" value="<%=rs.getString(1)%>"></td></tr>
			<tr><td>New Password:</td><td> <input type="password" name="pwd1" style="border-color:#000099; border-style:groove"></td></tr>
			

<tr>
  <td>Confirm Password:</td><td><input type="password" name="pwd2" style="border-color:#000099; border-style:groove"></td></tr>
