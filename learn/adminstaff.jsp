          ...
          <article class="col1">
            <div class="pad_left1">
			  ...
			  <h4>Employee Details:</h4>
                <div>
				<%! int emp,fac,adm,staf; %>
				<%
				try{
				emp=0;fac=0;adm=0;staf=0;
				ResultSet rs=st.executeQuery("select * from employee");
				while(rs.next()){
				emp++;
				if(rs.getString("desig").equalsIgnoreCase("admin"))
				adm++;
				else if(rs.getString("desig").equalsIgnoreCase("faculty"))
				fac++;
				else
				staf++;
				}
				...
				<br>
			<h3>
				Total no.of employees working in Learn Center is <%=emp%>.Among them <%=fac%> are faculties, <%=adm%> are admins and <%=staf%> staffs.<br><br>
				
				<ul class="list1">
              <li><a href="adminstaff1.jsp">Staff Details</a></li>
              <li><a href="adminother.jsp">Other Admins' Details</a></li>
			  <li><a href="adminfaculty.jsp">Faculty Details</a></li>
            </ul>
