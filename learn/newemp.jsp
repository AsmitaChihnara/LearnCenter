...
<html lang="en">
<head>
<title>Learn Center | Employee Sign Up</title>
<meta charset="utf-8">
...
function verify(){
 if(document.f1.name.value==""||document.f1.fname.value==""||document.f1.dob.value==""||document.f1.ge.value==""||document.f1.ph.value==""||document.f1.mail.value==""||document.f1.qual.value==""||document.f1.desig.value==""||document.f1.cadd.value==""||document.f1.padd.value==""||document.f1.pwd1.value==""||document.f1.pwd2.value==""||document.f1.secq.value==""||document.f1.seca.value==""){
      ...
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
			...
			<form action="newemp1.jsp" method="post" name="f1">
			<table><h3>
...
<tr><td>Qualification:</td><td><input type="text" name="qual" style="border-color:#000099; border-style:groove"></td></tr>
<tr><td>Designation:</td><td><input type="text" name="desig" style="border-color:#000099; border-style:groove"></td></tr>
