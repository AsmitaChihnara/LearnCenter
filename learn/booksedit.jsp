        ...
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              ...
              <h2 class="pad_bot1">OUR BOOK COLLECTIONS
            </div>
			...
			<a enctype="multipart/form-data" href="readbook.jsp" class="button"><span><span>Read book</span></span></a>
					 			<a href="adminbookedit.jsp" class="button"><span><span>Edit book details</span></span></a><a href="bookdelete.jsp" class="button"><span><span>Delete book</span></span></a>
