...
<html lang="en">
<head>
<title>Learn Center | Library Members</title>
<meta charset="utf-8">
      ...
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            ...
            <h2 class="font2">Choose the category you want to know the details</h2>
           <div class="wrapper pad_bot2">
			              <p class="pad_top2"><strong>
						 <h2 class="box1"> <br><input type="radio" name="t3" value="Admins">Admins
						  <br><input type="radio" name="t3" value="Employees">Employees
						  <br><input type="radio" name="t3" value="Faculties">Faculties
